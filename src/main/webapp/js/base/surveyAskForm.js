...
var submitNow = function($dialog, $grid, $pjq,$window) {
	...
	if ($(':input[name="data.id"]').val().length > 0) {
		url = com.sirius.skymall.user.contextPath + '/base/question!update.sy?type=3&surveyId='+const_sid;
	} else {
		url = com.sirius.skymall.user.contextPath + '/base/question!save.sy?type=3&surveyId='+const_sid;
	}
