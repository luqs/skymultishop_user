...
var submitNow = function($dialog, $grid, $pjq) {
	...
	if ($(':input[name="data.id"]').val().length > 0) {
		url = com.sirius.skymall.user.contextPath + '/base/staffuser!update.sy';
	} else {
		url = com.sirius.skymall.user.contextPath + '/base/staffuser!save.sy';
	}
...
$(function() {
	...
	if ($(':input[name="data.id"]').val().length > 0) {
		...
		$.post(com.sirius.skymall.user.contextPath + '/base/staffuser!getById.sy', {
