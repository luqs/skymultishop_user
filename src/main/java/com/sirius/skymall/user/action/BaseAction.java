...
import com.sirius.skymall.user.util.base.FastjsonFilter;
...
@Namespace("/")
@Action
public class BaseAction<T> extends ActionSupport implements Preparable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 3309118533694005097L;
    ...
    protected String productserver;
    protected String orderserver;
    protected String activityserver;
    protected String dbmanagementserver;
	public String getDbmanagementserver() {
		return dbmanagementserver;
	}

	public void setDbmanagementserver(String dbmanagementserver) {
		this.dbmanagementserver = dbmanagementserver;
	}
	...
	public String getEasyuiTheme() {
		return easyuiTheme;
	}

	public void setEasyuiTheme(String easyuiTheme) {
		this.easyuiTheme = easyuiTheme;
	}
	...
	public void prepare() throws Exception {
		...
		easyuiTheme = "bootstrap";//指定如果用户未选择样式，那么初始化一个默认样式
		...
		productserver = ConfigUtil.get("productserver");
		orderserver = ConfigUtil.get("orderserver");
		activityserver = ConfigUtil.get("activityserver");
		dbmanagementserver = ConfigUtil.get("dbmanagementserver");
		String User_Agent = getRequest().getHeader("User-Agent");
		isIE = false;
